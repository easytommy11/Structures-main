 ...
 */
var tommy = User(name: "Tommy", age: 16, height: 71.0   , weight: 180.6, activityLevel: 7)

print(tommy.activityLevel)

tommy.name = "Tommy "
print("My name is \(tommy.name). I am \(tommy.age), height \(tommy.height) and am \(tommy.weight) lbs and  my activity level is a \(tommy.activityLevel)")
